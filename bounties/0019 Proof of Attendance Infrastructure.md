...
| 4  | Deployed no-code tool for non-technical event organizers                   | Add a frontend (preferably a form) with wallet intergration (XUMM) for non-technical event organizers to mint and send event NFT's, the website should be deployed publicly | $1,500                   |
